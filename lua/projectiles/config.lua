    ...
    local menu_tabs = {
        ...
        },
        {
            ...
            vars = {
                ...
                { type = "float", cvar = "pro_wind_max_update_interval", label = "Max Update Interval (s)", min = 5.0, max = 300.0, decimals = 0 },
                { type = "float", cvar = "pro_wind_jitter_amount", label = "Turbulence Amount", min = 0.0, max = 2.0, decimals = 2 },
                { type = "header", label = "Wind Gusts" },
                { type = "float", cvar = "pro_wind_gust_chance", label = "Gust Chance", min = 0.0, max = 1.0, decimals = 2 },
                { type = "float", cvar = "pro_wind_gust_min_strength", label = "Gust Min Strength", min = 1.0, max = 5.0, decimals = 1 },
                { type = "float", cvar = "pro_wind_gust_max_strength", label = "Gust Max Strength", min = 1.0, max = 5.0, decimals = 1 },
                { type = "float", cvar = "pro_wind_gust_min_duration", label = "Gust Min Duration (s)", min = 0.5, max = 30.0, decimals = 1 },
                { type = "float", cvar = "pro_wind_gust_max_duration", label = "Gust Max Duration (s)", min = 0.5, max = 30.0, decimals = 1 },
            }
        },
        {

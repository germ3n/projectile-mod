...
SURFACE_PROPS_RICOCHET_CHANCE_MULTIPLIERS = {
    ["popcan"] = 0.8,
    ["concrete_block"] = 0.7,
    ["unknown"] = 0.0,
    ["grenade"] = 0.85,
    ...
    ["paper"] = 0.0,
    ["tile"] = 0.6,
    ["dufflebag_survivalCase"] = 0.0,
    ["woodladder"] = 0.1,
    ["plastic_barrel_buoyant"] = 0.2,
    ["rubbertire"] = 0.1,
    ["rubber"] = 0.0,
    ["metalvehicle"] = 0.9,
    ["wood_panel"] = 0.1,
    ...
    ["wood_furniture"] = 0.1,
    ["slowgrass"] = 0.0,
    ["slidingrubbertire_jalopyrear"] = 0.1,
    ["hunter"] = 0.3,
    ["slidingrubbertire"] = 0.1,
    ["solidmetal"] = 0.95,
    ["metalpanel"] = 0.85,
    ["gravel"] = 0.0,
    ["tile_survivalcase_gib"] = 0.6,
    ["glassbottle"] = 0.0,
    ["flesh"] = 0.0,
    ["crowbar"] = 0.9,
    ["brass_bell_medium"] = 0.9,
    ["combine_metal"] = 0.9,
    ["foliage"] = 0.0,
    ["wood_plank"] = 0.1,
    ["ladder"] = 0.8,
    ["sugarcane"] = 0.0,
    ["slidingrubbertire_front"] = 0.1,
    ["grate"] = 0.0,
    ["brick"] = 0.7,
    ["brass_bell_smallest"] = 0.85,
    ["chainlink"] = 0.0,
    ["concrete"] = 0.7,
    ["antlionsand"] = 0.0,
    ["dirt"] = 0.0,
    ["gm_ps_metaltire"] = 0.85,
    ["strider"] = 0.8,
    ["upholstery"] = 0.0,
    ["player"] = 0.0,
    ["jeeptire"] = 0.1,
    ["tile_survivalcase"] = 0.6,
    ["zombieflesh"] = 0.0,
    ["ceiling_tile"] = 0.5,
    ["brakingrubbertire"] = 0.1,
    ["gm_torpedo"] = 0.85,
    ["wood_lowdensity"] = 0.1,
    ["slipperyslime"] = 0.0,
    ["slipperyslide"] = 0.9,
    ["plastic_barrel"] = 0.2,
    ["snow"] = 0.0,
    ["player_control_clip"] = 0.0,
    ["blockbullets"] = 0.95,
    ["water"] = 0.0,
    ["ice"] = 0.5,
    ["wood"] = 0.1,
    ["slidingrubbertire_rear"] = 0.1,
    ["metal_bouncy"] = 0.9,
    ["metal_barrellight_hl"] = 0.8,
    ["weapon"] = 0.8,
    ["pottery"] = 0.3,
    ["plaster"] = 0.3,
    ["watermelon"] = 0.0,
    ...
    ["metalgrate"] = 0.0,
    ["default"] = 0.0,
    ["metal_survivalcase_unpunchable"] = 0.9,
    ["chain"] = 0.0,
    ["metal_barrel_hl"] = 0.85,
    ["plastic"] = 0.2,
    ["alienflesh"] = 0.0,
    ["wet"] = 0.0,
    ["hay"] = 0.0,
    ...
    ["wood_box"] = 0.1,
    ["no_decal"] = 0.0,
    ["slidingrubbertire_jalopyfront"] = 0.1,
    ["clay"] = 0.0,
    ["gmod_ice"] = 0.5,
    ["combine_glass"] = 0.0,
    ["gm_ps_woodentire"] = 0.1,
    ["metal_vehicle"] = 0.9,
    ["papercup"] = 0.0,
    ["gunship"] = 0.9,
    ["mud"] = 0.0,
    ["cement"] = 0.7,
    ["plastic_barrel_verybuoyant"] = 0.2,
    ["phx_explosiveball"] = 0.85,
    ["cavern_rock"] = 0.7,
    ["wood_crate"] = 0.1,
    ["antlion"] = 0.0,
    ["gmod_bouncy"] = 0.5,
    ...
    ["stucco"] = 0.5,
    ["wood_dense"] = 0.2,
    ["floating_metal_barrel"] = 0.85,
    ["carpet"] = 0.0,
    ["plastic_survivalcase"] = 0.2,
    ["floatingstandable"] = 0.1,
    ["plastic_box"] = 0.2,
    ["cardboard"] = 0.0,
    ["metalvent"] = 0.8,
    ["wood_solid"] = 0.2,
    ["metal_survivalcase"] = 0.9,
    ["brass_bell_large"] = 0.9,
    ["default_silent"] = 0.0,
    ["porcelain"] = 0.3,
    ["asphalt"] = 0.6,
    ["armorflesh"] = 0.3,
